...
.method static constructor <clinit>()V
    ...
    .line 66
    sget v5, Lcom/android/systemui/R$drawable;->dessert_cupcake:I

    aput v5, v2, v3

    sget v5, Lcom/android/systemui/R$drawable;->dessert_donut:I

    aput v5, v2, v4

    sget v5, Lcom/android/systemui/R$drawable;->dessert_eclair:I

    aput v5, v2, v0

    sget v5, Lcom/android/systemui/R$drawable;->dessert_froyo:I

    const/4 v6, 0x3

    aput v5, v2, v6

    sget v5, Lcom/android/systemui/R$drawable;->dessert_gingerbread:I

    const/4 v7, 0x4

    aput v5, v2, v7

    sget v5, Lcom/android/systemui/R$drawable;->dessert_honeycomb:I

    const/4 v8, 0x5

    aput v5, v2, v8

    sget v5, Lcom/android/systemui/R$drawable;->dessert_ics:I

    const/4 v8, 0x6

    aput v5, v2, v8

    sget v5, Lcom/android/systemui/R$drawable;->dessert_jellybean:I

    const/4 v8, 0x7

    aput v5, v2, v8

    sput-object v2, Lcom/android/systemui/DessertCaseView;->RARE_PASTRIES:[I

    new-array v5, v7, [I

    .line 77
    sget v7, Lcom/android/systemui/R$drawable;->dessert_petitfour:I

    aput v7, v5, v3

    sget v7, Lcom/android/systemui/R$drawable;->dessert_donutburger:I

    aput v7, v5, v4

    sget v7, Lcom/android/systemui/R$drawable;->dessert_flan:I

    aput v7, v5, v0

    sget v7, Lcom/android/systemui/R$drawable;->dessert_keylimepie:I

    aput v7, v5, v6

    sput-object v5, Lcom/android/systemui/DessertCaseView;->XRARE_PASTRIES:[I

    new-array v6, v6, [I

    .line 89
    sget v7, Lcom/android/systemui/R$drawable;->dessert_zombiegingerbread:I

    aput v7, v6, v3

    sget v3, Lcom/android/systemui/R$drawable;->dessert_dandroid:I

    aput v3, v6, v4

    sget v3, Lcom/android/systemui/R$drawable;->dessert_jandycane:I

    aput v3, v6, v0

    sput-object v6, Lcom/android/systemui/DessertCaseView;->XXRARE_PASTRIES:[I
