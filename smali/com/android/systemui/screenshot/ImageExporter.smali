...
.method public static synthetic $r8$lambda$mEEXFTHO31QsJTPapDwmRglQ8Oo(Lcom/android/systemui/screenshot/ImageExporter;Landroid/graphics/Bitmap;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/systemui/screenshot/ImageExporter;->lambda$exportAsTempFile$0(Landroid/graphics/Bitmap;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V

    return-void
.end method

.method public static synthetic $r8$lambda$mjRYsWa0ZELYIv6t0a2aOMK7kXo(Lcom/android/systemui/screenshot/ImageExporter;Ljava/util/concurrent/Executor;Landroid/graphics/Bitmap;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/systemui/screenshot/ImageExporter;->lambda$exportAsTempFile$1(Ljava/util/concurrent/Executor;Landroid/graphics/Bitmap;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
...
.method private synthetic lambda$exportAsTempFile$0(Landroid/graphics/Bitmap;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    .locals 3

    :try_start_0
    const-string v0, "long_screenshot_cache_"
    ...
    .line 124
    :try_start_2
    iget-object v2, p0, Lcom/android/systemui/screenshot/ImageExporter;->mCompressFormat:Landroid/graphics/Bitmap$CompressFormat;
...
.method private synthetic lambda$exportAsTempFile$1(Ljava/util/concurrent/Executor;Landroid/graphics/Bitmap;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-direct {v0, p0, p2, p3}, Lcom/android/systemui/screenshot/ImageExporter$$ExternalSyntheticLambda3;-><init>(Lcom/android/systemui/screenshot/ImageExporter;Landroid/graphics/Bitmap;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
...
.method exportAsTempFile(Ljava/util/concurrent/Executor;Landroid/graphics/Bitmap;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1, p2}, Lcom/android/systemui/screenshot/ImageExporter$$ExternalSyntheticLambda0;-><init>(Lcom/android/systemui/screenshot/ImageExporter;Ljava/util/concurrent/Executor;Landroid/graphics/Bitmap;)V
