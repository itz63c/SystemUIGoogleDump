...
.method public static create(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;)Lcom/android/systemui/qs/carrier/QSCarrierGroupController_Builder_Factory;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 63
    new-instance v8, Lcom/android/systemui/qs/carrier/QSCarrierGroupController_Builder_Factory;
    ...
    invoke-direct/range {v0 .. v7}, Lcom/android/systemui/qs/carrier/QSCarrierGroupController_Builder_Factory;-><init>(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;)V

    return-object v8
.end method

.method public static newInstance(Lcom/android/systemui/plugins/ActivityStarter;Landroid/os/Handler;Landroid/os/Looper;Lcom/android/systemui/statusbar/policy/NetworkController;Lcom/android/keyguard/CarrierTextManager$Builder;Landroid/content/Context;Lcom/android/systemui/util/CarrierConfigTracker;)Lcom/android/systemui/qs/carrier/QSCarrierGroupController$Builder;
    .locals 9

    .line 70
    new-instance v8, Lcom/android/systemui/qs/carrier/QSCarrierGroupController$Builder;
    ...
    invoke-direct/range {v0 .. v7}, Lcom/android/systemui/qs/carrier/QSCarrierGroupController$Builder;-><init>(Lcom/android/systemui/plugins/ActivityStarter;Landroid/os/Handler;Landroid/os/Looper;Lcom/android/systemui/statusbar/policy/NetworkController;Lcom/android/keyguard/CarrierTextManager$Builder;Landroid/content/Context;Lcom/android/systemui/util/CarrierConfigTracker;)V
...
.method public get()Lcom/android/systemui/qs/carrier/QSCarrierGroupController$Builder;
    ...
    iget-object p0, p0, Lcom/android/systemui/qs/carrier/QSCarrierGroupController_Builder_Factory;->carrierConfigTrackerProvider:Ljavax/inject/Provider;
    ...
    invoke-static/range {v1 .. v7}, Lcom/android/systemui/qs/carrier/QSCarrierGroupController_Builder_Factory;->newInstance(Lcom/android/systemui/plugins/ActivityStarter;Landroid/os/Handler;Landroid/os/Looper;Lcom/android/systemui/statusbar/policy/NetworkController;Lcom/android/keyguard/CarrierTextManager$Builder;Landroid/content/Context;Lcom/android/systemui/util/CarrierConfigTracker;)Lcom/android/systemui/qs/carrier/QSCarrierGroupController$Builder;
