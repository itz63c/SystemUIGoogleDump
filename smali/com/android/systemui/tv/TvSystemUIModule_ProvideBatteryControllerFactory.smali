...
.method public static create(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;)Lcom/android/systemui/tv/TvSystemUIModule_ProvideBatteryControllerFactory;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            "Landroid/os/Handler;",
            ">;)",
            "Lcom/android/systemui/tv/TvSystemUIModule_ProvideBatteryControllerFactory;"
        }
    .end annotation

    .line 64
    new-instance v8, Lcom/android/systemui/tv/TvSystemUIModule_ProvideBatteryControllerFactory;
    ...
    invoke-direct/range {v0 .. v7}, Lcom/android/systemui/tv/TvSystemUIModule_ProvideBatteryControllerFactory;-><init>(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;)V
...
.method public static provideBatteryController(Landroid/content/Context;Lcom/android/systemui/power/EnhancedEstimates;Landroid/os/PowerManager;Lcom/android/systemui/broadcast/BroadcastDispatcher;Lcom/android/systemui/demomode/DemoModeController;Landroid/os/Handler;Landroid/os/Handler;)Lcom/android/systemui/statusbar/policy/BatteryController;
    ...
    .line 71
    invoke-static/range {p0 .. p6}, Lcom/android/systemui/tv/TvSystemUIModule;->provideBatteryController(Landroid/content/Context;Lcom/android/systemui/power/EnhancedEstimates;Landroid/os/PowerManager;Lcom/android/systemui/broadcast/BroadcastDispatcher;Lcom/android/systemui/demomode/DemoModeController;Landroid/os/Handler;Landroid/os/Handler;)Lcom/android/systemui/statusbar/policy/BatteryController;
...
.method public get()Lcom/android/systemui/statusbar/policy/BatteryController;
    ...
    invoke-static/range {v1 .. v7}, Lcom/android/systemui/tv/TvSystemUIModule_ProvideBatteryControllerFactory;->provideBatteryController(Landroid/content/Context;Lcom/android/systemui/power/EnhancedEstimates;Landroid/os/PowerManager;Lcom/android/systemui/broadcast/BroadcastDispatcher;Lcom/android/systemui/demomode/DemoModeController;Landroid/os/Handler;Landroid/os/Handler;)Lcom/android/systemui/statusbar/policy/BatteryController;
...
.method public bridge synthetic get()Ljava/lang/Object;
    ...
    .line 15
    invoke-virtual {p0}, Lcom/android/systemui/tv/TvSystemUIModule_ProvideBatteryControllerFactory;->get()Lcom/android/systemui/statusbar/policy/BatteryController;
