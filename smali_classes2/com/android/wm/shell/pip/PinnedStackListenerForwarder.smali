...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/wm/shell/pip/PinnedStackListenerForwarder$PinnedStackListener;,
        Lcom/android/wm/shell/pip/PinnedStackListenerForwarder$PinnedStackListenerImpl;
    }
.end annotation


# instance fields
.field private final mListenerImpl:Landroid/view/IPinnedStackListener;
...
.method public constructor <init>(Lcom/android/wm/shell/common/ShellExecutor;)V
    ...
    .line 40
    new-instance v0, Lcom/android/wm/shell/pip/PinnedStackListenerForwarder$PinnedStackListenerImpl;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/android/wm/shell/pip/PinnedStackListenerForwarder$PinnedStackListenerImpl;-><init>(Lcom/android/wm/shell/pip/PinnedStackListenerForwarder;Lcom/android/wm/shell/pip/PinnedStackListenerForwarder$1;)V

    iput-object v0, p0, Lcom/android/wm/shell/pip/PinnedStackListenerForwarder;->mListenerImpl:Landroid/view/IPinnedStackListener;
...
.method private onActionsChanged(Landroid/content/pm/ParceledListSlice;)V
    ...
    check-cast v0, Lcom/android/wm/shell/pip/PinnedStackListenerForwarder$PinnedStackListener;

    .line 77
    invoke-virtual {v0, p1}, Lcom/android/wm/shell/pip/PinnedStackListenerForwarder$PinnedStackListener;->onActionsChanged(Landroid/content/pm/ParceledListSlice;)V
...
.method private onActivityHidden(Landroid/content/ComponentName;)V
    ...
    .line 83
    invoke-virtual {v0, p1}, Lcom/android/wm/shell/pip/PinnedStackListenerForwarder$PinnedStackListener;->onActivityHidden(Landroid/content/ComponentName;)V
...
.method private onAspectRatioChanged(F)V
    ...
    .line 89
    invoke-virtual {v0, p1}, Lcom/android/wm/shell/pip/PinnedStackListenerForwarder$PinnedStackListener;->onAspectRatioChanged(F)V
...
.method private onImeVisibilityChanged(ZI)V
    ...
    .line 71
    invoke-virtual {v0, p1, p2}, Lcom/android/wm/shell/pip/PinnedStackListenerForwarder$PinnedStackListener;->onImeVisibilityChanged(ZI)V
...
.method private onMovementBoundsChanged(Z)V
    ...
    .line 65
    invoke-virtual {v0, p1}, Lcom/android/wm/shell/pip/PinnedStackListenerForwarder$PinnedStackListener;->onMovementBoundsChanged(Z)V
...
# virtual methods
.method public addListener(Lcom/android/wm/shell/pip/PinnedStackListenerForwarder$PinnedStackListener;)V
    .locals 0
...
.method public register(I)V
    ...
    iget-object p0, p0, Lcom/android/wm/shell/pip/PinnedStackListenerForwarder;->mListenerImpl:Landroid/view/IPinnedStackListener;

    invoke-interface {v0, p1, p0}, Landroid/view/IWindowManager;->registerPinnedStackListener(ILandroid/view/IPinnedStackListener;)V
